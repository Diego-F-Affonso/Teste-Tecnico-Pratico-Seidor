  ...
  render() {
    return (
      <div className="information__wrapper">
        ...
        <p>Isso quer dizer que é essa a fonte para você saber qual é o percentual que deve ser aplicado sobre os seus rendimentos.<br />Portanto, na hora de fazer cálculo e declarar seus rendimentos, ter essa tabela é fundamental para que você não envie <b>nenhum dado errado e, consequentemente, não caia na malha fina.</b></p>
      </div>
    )
  }
}
